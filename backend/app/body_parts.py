...
BODY_PART_POSES = {
    ...
    'hips': [
        'Supine Bound Angle', 'Gomukasana Legs Fold', 'Warrior II Left', 'Warrior II Right',
        'Tree Pose Left', 'Tree Pose Right', 'Janu Sirsasana Twist Left', 'Janu Sirsasana Twist Right',
        'Easy Seat'
    ],
    ...
    'flexibility': [
        'Downward Dog', 'Gomukasana Legs Fold', 'Janu Sirsasana Revolved Left',
        'Janu Sirsasana Revolved Right', 'Supine Bound Angle'
    ],
...
def is_asymmetric_pose(pose_name: str) -> bool:
    ...
    for left, right in ASYMMETRIC_POSE_PAIRS:
        if pose_name == left or pose_name == right:
            return True
    return False
